  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="admin-user.php" method="get">
          <div class="am-form-group">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="telephone" id="user-phone" placeholder="输入你的电话号码 / Telephone">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="qq" id="user-QQ" placeholder="输入你的QQ号码">
            </div>
          </div>
